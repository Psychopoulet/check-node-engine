...
describe("minimumVersionFromEngine", () => {
    ...
    it("should return exact versions", () => {
        strictEqual(minimumVersionFromEngine("22.23.2"), "22.23.2");
        strictEqual(minimumVersionFromEngine("v22.23.2"), "22.23.2");
        strictEqual(minimumVersionFromEngine("22"), "22.0.0");
    });

    it("should trim surrounding whitespace", () => {
        strictEqual(minimumVersionFromEngine("  >=22.23.2  "), "22.23.2");
        strictEqual(minimumVersionFromEngine("\tv22.23.2\n"), "22.23.2");
    });
    ...
    it("should return minimum for comparator ranges", () => {
        ...
        strictEqual(minimumVersionFromEngine("<=22.23.2"), "0.0.0");
    });
